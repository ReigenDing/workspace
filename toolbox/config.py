...
# 默认的日志输出
DEFAULT_LOGGER = util.get_default_logger()
...
COMMON_REGEX = {
    ...
    # URL    https?://    域名       端口号        路径        文件类型 ？             键值对
    'URL': r'https?://([^/:\"\'<>]+)(:\d*)?(/?[^\.\s\"\'<>]+)(\.\w+)?\??(&?[^=\s<>\"\']+=[^&\s<>\"\']+)*',
...
PROXY_SERVICE = {
    "abuyun": [
        {
            ...
            "proxy_passport": "H6J1520951F2B4HD",
            "proxy_pass": "69A118FD8050A112"
        },
        {
            "proxy_server": "http-dyn.abuyun.com:9020",
            "proxy_passport": "H0AK9V63A4M599BD",
            "proxy_pass": "C73DFE5DBDD22156"
        },
        {
            "proxy_server": "http-dyn.abuyun.com:9020",
            "proxy_passport": "H6J1520951F2B4HD",
    ...
    "xdaili": [
        ...
        {
            "proxy_server": "forward.xdaili.cn:80",
            "proxy_passport": "ZF20185280888KbJDzi",
            "proxy_pass": "266ec56b3c304c37b3ce69f4d3357bb7"
        },
        {
            "proxy_server": "forward.xdaili.cn:80",
            "proxy_passport": "ZF2018528219496KZuN",
            "proxy_pass": "266ec56b3c304c37b3ce69f4d3357bb7"
        },
        {
            "proxy_server": "forward.xdaili.cn:80",
            "proxy_passport": "ZF20185212720R11rDH",
            "proxy_pass": "266ec56b3c304c37b3ce69f4d3357bb7"
        },
        {
            "proxy_server": "forward.xdaili.cn:80",
            "proxy_passport": "ZF20185168746pkNSJW",
            "proxy_pass": "266ec56b3c304c37b3ce69f4d3357bb7"
        },

    ],
    "data5u": [
        "http://api.ip.data5u.com/dynamic/get.html?order=1d2e99c6aede6f64a211a2d8b77931c8",
    ]
}
